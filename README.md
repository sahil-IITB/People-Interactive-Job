...
## About me
I build reproducible image-processing pipelines and scalable retrieval systems. I focus on clean, maintainable code and delivering product-quality features. My recent work includes contactless biometric attendance systems, CNN-based FER models, and large-scale approximate nearest neighbor search (FLINNG).

---

## Featured projects

### 1) Contactless Biometric Attendance System
...
### 2) Facial Expression Recognition (FER-2013)
...
## Technical Skills
- **Languages:** Python, C/C++, MATLAB, Embedded C, SQL  
- **CV / ML:** PyTorch, TensorFlow, OpenCV, Scikit-learn  
- **Tools:** Git, Simulink, LaTeX, Cadence, Arduino  
- **Areas:** Image processing, Signal processing, Machine learning, Retrieval systems
...
## Contact
- Email: sahil.patil.ee@iitb.ac.in  
- GitHub: https://github.com/sahil-IITB
